...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER,
            array("X-Api-Key:test_6c1c3bc6e0925e9529ccea31c7d",
                  "X-Auth-Token:test_c88e0577ff7419328f735afe515"));
		$payload = Array(
			'purpose' => 'Buy Product',
			'amount' => $total_price,
			'phone' => $userArr['mobile'],
			'buyer_name' => $userArr['name'],
			'redirect_url' => 'http://127.0.0.1/ecom-7.3/ecom-19-instamojo/payment_complete.php',
			'send_email' => true,
